const { SlashCommandBuilder, EmbedBuilder, MessageFlags, SeparatorComponent, SeparatorBuilder } = require("discord.js");
const config = require("../../config.js");
const { separator } = require("../../components.js");
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      const texts = require(`../../lang/${interaction.guild.preferredLocale}.js`);
        if (!interaction.member.roles.cache.has(config.roles.moderator)) {
        return await interaction.reply({
          flags: [MessageFlags.Ephemeral, MessageFlags.IsComponentsV2],
          components: [texts.modControlText, separator]
        });
      }
